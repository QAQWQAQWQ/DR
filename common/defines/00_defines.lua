...
NProduction = {
	...
	MINIMUM_NUMBER_OF_FACTORIES_TAKEN_BY_CONSUMER_GOODS_VALUE = 0,		-- The minimum number of factories we have to put on consumer goods, by value.(changed on 2024.4.21)
	MINIMUM_NUMBER_OF_FACTORIES_TAKEN_BY_CONSUMER_GOODS_PERCENT = 0,	-- The minimum number of factories we have to put on consumer goods, in percent.(changed on 2024.4.21)
},
...
NMilitary = {
	...
	RIVER_CROSSING_PENALTY_LARGE = -0.37,           -- large river crossing
