...
NMilitary = {
	...
	RIVER_CROSSING_PENALTY = -0.32,                 -- small river crossing
	RIVER_CROSSING_PENALTY_LARGE = -0.62,           -- large river crossing
	RIVER_CROSSING_SPEED_PENALTY = -0.27,           -- small river crossing
	RIVER_CROSSING_SPEED_PENALTY_LARGE = -0.52,     -- large river crossing
