...
NMilitary = {
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 6,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
...
NAI = {
	...
	CALL_ALLY_DEMOCRATIC_DESIRE = 50,			-- Desire to call ally added for Liberalism AI
	...
	JOIN_ALLY_DEMOCRATIC_DESIRE = 50,			-- Desire to join ally added for Liberalism AI
	...
	DEMOCRATIC_AI_FACTION_KICKING_PLAYER_THREAT_DIFFERENCE = 6.0, -- World threat generation difference needed to kick a player from a Liberalism faction
	BEFRIEND_FACTOR_FOR_KICKING_COUNTRIES = 7.5,		-- World threat difference addition per 100 befriend against a country, Liberalism leaders will forgive allies if they are befriending them
